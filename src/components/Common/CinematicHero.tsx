...
export const CinematicHero: React.FC<CinematicHeroProps> = ({
  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white shadow-2xl">
      ...
      <div className="border-b border-slate-800/80 bg-slate-950/70 backdrop-blur-md px-5 py-2.5 flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 text-cyan-400">
            <Radio className="w-3.5 h-3.5 animate-pulse" />
            <span className="font-semibold uppercase tracking-wider">ArogyaSeva Clinical Telemetry</span>
          </div>
        ...
        <div className="flex items-center gap-4 text-slate-400">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-slate-300 font-medium">
              {isOffline ? "LOCAL ETAT PROTOCOL (OFFLINE CACHE)" : "WHO-IMCI AI ENGINE: ONLINE"}
            </span>
          </div>
      ...
      <div className="relative p-6 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-7 space-y-5">
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/80 border border-cyan-500/40 text-cyan-300 text-xs font-semibold backdrop-blur-xs shadow-xs">
            <Sparkles className="w-3.5 h-3.5 text-cyan-400 animate-spin" />
            <span>AI-Powered Frontline Triage & Referral Mesh</span>
            <span className="bg-cyan-500/20 text-cyan-200 px-1.5 py-0.2 rounded text-[10px] uppercase font-bold">
              v2.5
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold text-sm shadow-lg shadow-cyan-500/25 flex items-center gap-2.5 transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="px-5 py-3 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-200 hover:text-white font-semibold text-sm border border-slate-700 backdrop-blur-xs flex items-center gap-2 transition-all hover:border-slate-500"
            >
          ...
          <div className="grid grid-cols-3 gap-3 pt-3 border-t border-slate-800/80 text-xs">
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-mono block">Zero Signal</span>
              <span className="font-bold text-white text-sm">100% Offline Ready</span>
            </div>
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-mono block">Dialect AI</span>
              <span className="font-bold text-white text-sm">6 Indian Languages</span>
            </div>
            <div>
              <span className="text-slate-400 text-[10px] uppercase font-mono block">Triage Speed</span>
              <span className="font-bold text-white text-sm">&lt; 90 Seconds</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 relative flex flex-col items-center justify-center">
          <div className="w-full h-64 sm:h-72 lg:h-80 relative rounded-2xl border border-slate-800/80 bg-slate-950/60 backdrop-blur-sm overflow-hidden shadow-inner">
