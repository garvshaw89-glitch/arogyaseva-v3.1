...
export const CHWAppView: React.FC<CHWAppViewProps> = ({
  ...
  type CHWTab = "dashboard" | "intake" | "triage" | "patients" | "history" | "referrals" | "emergency";
  ...
  // QR Code Scanner callback in CHW App View
  const handlePatientIdentified = (data: ScannedMedicalIdData, matchedCase?: PatientCase) => {
    ...
    if (matchedCase) {
      ...
      setCurrentPatient((prev) => ({
        ...
        isPregnant: data.isPregnant ?? prev.isPregnant ?? false,
  ...
  const handleOpenIdCard = (patient: Partial<PatientCase>) => {
    playHapticSound("click");
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] bg-glass-atmosphere flex flex-col font-sans">
      {/* -------------------------------------------------------------
          2. CHW Dedicated Application Topbar (Clinical Glass Header)
          ------------------------------------------------------------- */}
      <header className="sticky top-0 z-30 h-16 bg-white/85 backdrop-blur-xl border-b border-white/90 px-4 sm:px-6 flex items-center justify-between shadow-2xs">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#0F2347] to-[#2563EB] flex items-center justify-center text-white font-bold shadow-md shadow-blue-900/15 ring-1 ring-white/50">
              <HeartPulse className="w-4 h-4 text-[#06B6D4] animate-pulse" />
            </div>
            <div>
              <div className="text-sm font-extrabold text-[#0F172A] leading-tight flex items-center gap-2">
                <span>ASHA Clinical Workstation</span>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside
          className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white/80 backdrop-blur-xl border-r border-slate-200/80 flex flex-col justify-between transition-transform duration-200 ease-in-out shadow-xs ${
        ...
        >
          <div className="p-4 space-y-5">
            ...
            <button
              ...
              className="glass-btn-primary w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold text-white shadow-md cursor-pointer"
            >
              <UserPlus className="w-4 h-4 text-[#06B6D4]" />
              <span>New Patient Intake</span>
            </button>

            {/* Quick Action: Scan Medical ID (QR) */}
            <button
              type="button"
              onClick={() => {
                playHapticSound("click");
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold text-slate-700 bg-white hover:bg-slate-50 border border-slate-200/80 shadow-2xs cursor-pointer transition-all hover:border-blue-300 hover:text-blue-900"
              title="Quickly scan patient's Ayushman Bharat or medical ID card"
            >
              <QrCode className="w-4 h-4 text-blue-600" />
              <span>Scan Medical ID (QR)</span>
            </button>
                ...
                return (
                  ...
                  >
                    ...
                    {item.count !== undefined && (
                      <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-slate-200/80 text-slate-700">
                        {item.count}
                      </span>
                    )}
                  </button>
          ...
          {/* Sidebar Footer Info */}
          <div className="p-4 border-t border-slate-200/60 text-[11px] text-slate-500 space-y-2">
            <div className="flex items-center justify-between">
              <span>National Hotline</span>
              <span className="font-bold text-red-600 font-mono">108</span>
            </div>
            <div className="text-[10px] text-slate-400">
              ArogyaSeva v2.4 • Offline-First Glass
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 overflow-y-auto p-3 sm:p-6 lg:p-8 text-left pb-24 lg:pb-8">
          ...
          {activeTab === "dashboard" && (
            <div className="max-w-6xl mx-auto space-y-6">
              ...
              <div className="glass-level-2 rounded-2xl border border-white/90 p-4 sm:p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 w-full md:w-auto">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white text-xs font-bold flex items-center justify-center gap-2 shadow-md cursor-pointer min-h-[44px] transition-all"
                    title="Scan patient's Ayushman Bharat, ABHA card, or clinic QR"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="glass-card p-5 rounded-2xl border border-white/90 shadow-2xs hover:shadow-md">
                ...
                <div className="glass-card p-5 rounded-2xl border border-red-200/60 shadow-2xs hover:shadow-md bg-red-50/20">
                ...
                <div className="glass-card p-5 rounded-2xl border border-amber-200/60 shadow-2xs hover:shadow-md bg-amber-50/20">
                ...
                <div className="glass-card p-5 rounded-2xl border border-emerald-200/60 shadow-2xs hover:shadow-md bg-emerald-50/20">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {onOpenPdfReport && (
                            <button
                              ...
                              className="px-2 py-1 rounded-lg bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 text-xs font-bold flex items-center gap-1 transition-all cursor-pointer"
                            ...
                            <div className="flex items-center justify-end gap-2">
                              {onOpenPdfReport && (
                                <button
                                  ...
                                  className="px-2 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-xs font-bold flex items-center gap-1 transition-all cursor-pointer"
                              ...
                              <button
                                ...
                                className="px-2 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold flex items-center gap-1 transition-all cursor-pointer"
                                title="View & Print Digital Medical ID Card"
                              >
                              ...
                              <button
                                ...
                                className="px-2 py-1 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-xs font-bold flex items-center gap-1 transition-all cursor-pointer"
          ...
          {activeTab === "intake" && (
            <ClinicalIntakeWorkspace
              ...
              onViewPatientHistory={(p) => {
                setCurrentPatient((prev) => ({ ...prev, ...p }));
                setActiveTab("history");
              }}
            />
          )}
          ...
          {/* =========================================================
              VIEW: Patient History (Local Storage Index)
              ========================================================= */}
          {activeTab === "history" && (
            <PatientHistoryView
              ...
              onOpenIdCard={(p) => handleOpenIdCard(p)}
              onOpenQrScanner={() => setQrScannerOpen(true)}
              onStartIntakeForPatient={(p) => {
                setCurrentPatient((prev) => ({
                  ...prev,
                  ...p,
                  id: `case-${Date.now()}`,
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 max-w-md w-full">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold flex items-center gap-1.5 shadow-xs transition-colors cursor-pointer shrink-0"
                    title="Scan Patient Medical ID Card (ABHA / QR)"
                  >
                    <QrCode className="w-3.5 h-3.5" />
                    <span className="hidden sm:inline">Scan Medical ID</span>
                    ...
                    <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          type="button"
                          onClick={() => handleOpenIdCard(c)}
                          className="px-2 py-1 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-[11px] font-bold flex items-center gap-1 cursor-pointer transition-colors"
                        ...
                        <button
                          ...
                          className="px-2 py-1 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 text-[11px] font-bold flex items-center gap-1 cursor-pointer transition-colors"
                          title="View past clinical cases in Local Storage Index"
                        >
                          <History className="w-3 h-3 text-indigo-600" />
                          <span>History</span>
                        ...
                        <div className="flex items-center gap-2">
                          {onOpenPdfReport && (
                            <button
                              ...
                              className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white text-xs font-bold flex items-center gap-1.5 shadow-xs cursor-pointer"
                              title="Generate official referral PDF"
                            >
